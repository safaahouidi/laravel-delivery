...
<body>
    ...
    <div class="container">
        <div class="cont">
            ...
            <form action="{{route('adminServiceDestroy',$service->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
            ...
            <a href=" {{route('serviceview-Admin')}}"><button class="btn btn-primary mt-3">back to about view</button></a>
        </div>
</body>
